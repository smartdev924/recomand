...
import 'package:localservice/screens/direct_my_job_offerid/components/direct_job_offer_item_card.dart';
...
class _BodyState extends State<Body> {
  ...
  Future<void> getOfferById() async {
    dynamic response =
        await _appService.getOfferById(offerID: int.parse(widget.offerID));
    if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      children: [
        ...
        Expanded(
          child: isLoaded
              ? DirectJobOfferItemCard(data: offerData)
              : Center(
