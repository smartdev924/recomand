...
class DirectChatWidget extends StatefulWidget {
  @override
  State<DirectChatWidget> createState() => _DirectChatWidgetState();
}

class _DirectChatWidgetState extends State<DirectChatWidget> {
  ...
  Widget workDirectChatWidget(BuildContext context) {
