...
class GooglePayCardCard extends StatefulWidget {
  @override
  _GooglePayCardCardState createState() => _GooglePayCardCardState();
}

class _GooglePayCardCardState extends State<GooglePayCardCard> {
  ...
  Widget build(BuildContext context) {
    Future.delayed(Duration.zero, () {
      setState(() {
        if (_appService.paymentMethodList['google_pay'] == true)
          currentPayment = _appService.currentPaymentMethod;
        else
          currentPayment = null;
      });
    ...
    return InkWell(
        onTap: () {
          setState(() {
            _appService.currentPaymentMethod = enumPaymentMethod.google_pay;
            currentPayment = enumPaymentMethod.google_pay;
          });
        },
        child: Container(
            ...
            children: [
              ...
              Expanded(
                  ...
                  child: Radio<enumPaymentMethod>(
                    value: enumPaymentMethod.google_pay,
