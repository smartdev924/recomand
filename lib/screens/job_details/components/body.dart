...
class _BodyState extends State<Body> {
  ...
  _onMenuItemSelected(int value, BuildContext context) async {
    ...
    if (value == 2) {
      ...
      await Share.share(_appService.selectedJobData['url'].toString(),
          subject: "",
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Flexible(
                                    child: Text(
                                  _appService.selectedJobData['address'] == null
                                      ? Languages.of(context)!.no_city_info
                                      : _appService.selectedJobData['address'],
                            ...
                            InkWell(
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(width: 10),
                                  Text(
                                    _appService.selectedJobData['phone'] == null
                                        ? " "
                                        : _appService
                                                .selectedJobData['is_locked']
                                            ? _appService
                              ...
                              onTap: () {
                                if (!kIsWeb) {
                                  if (Platform.isAndroid || Platform.isIOS) {
                                    if (_appService.selectedJobData['phone'] !=
                                            null &&
                                        _appService.selectedJobData['phone'] !=
                                            "")
                                      _callNumber(
                                          _appService.selectedJobData['phone']);
                                  }
                    ...
                    _appService.selectedJobData['questions'] == null
                        ? Container()
                        : _appService.selectedJobData['questions'].length == 0
                            ? Container()
                            : Container(
                    ...
                    if (_appService.selectedJobData['customer'] != null)
                      Container(
                          padding: EdgeInsets.symmetric(horizontal: 20),
                          child: Text(
                            displayTimeAgoFromTimestamp(_appService
                                .selectedJobData['customer']['date_joined']),
                            style: TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize: 16,
                                color: context
                    ...
                    _appService.selectedJobData['reviews_info'] == null
                        ...
                        : _appService.selectedJobData['reviews_info'].length ==
                                0
                            ? Container(
                                padding: EdgeInsets.all(20),
                                child: Text(
                            ...
                            : Container(
                                ...
                                child: Text(
                                  _appService.selectedJobData['reviews_info']
                                          .length
                                          .toString() +
                                      Languages.of(context)!.receivedOffers,
                                  style: TextStyle(
                                      color: Color.fromRGBO(79, 162, 219, 1),
                                      fontSize: 20,
                                      fontWeight: FontWeight.w500),
                    ...
                    _appService.selectedJobData['reviews_info'] != null &&
                        ...
                        ? ListView.builder(
                            ...
                            itemBuilder: (ctx, index) => Container(
                                ...
                                child: Row(children: [
                                  RatingBar.builder(
                                    initialRating: double.parse(_appService
                                        .selectedJobData['reviews_info'][index]
                                            ['medie']
                                        .toString()),
                                    minRating: 1,
                        ...
                        : Container(
                            ...
                            child: Text(Languages.of(context)!.beFirstSend,
                                style: TextStyle(
                                    fontSize: 18,
          ...
          : Container(
              ...
              child: _appService.user['is_worker'] == true &&
                  ...
                  ? DefaultButton(
                      ...
                      press: () {
                        GoRouter.of(context)
                            .pushNamed(APP_PAGE.updateOffer.toName);
                      })
                  : DefaultButton(
          ...
          child: _appService.isFromBrowser
              ? PopupMenuButton(
                  onSelected: (value) async {
                    ...
                    if (value == 2) {
                      final box = context.findRenderObject() as RenderBox?;
                      await Share.share(_appService.selectedJobData['url'],
                          subject: "",
                          sharePositionOrigin:
