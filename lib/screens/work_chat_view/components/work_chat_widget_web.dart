...
class WorkChatWidgetWeb extends StatefulWidget {
  @override
  State<WorkChatWidgetWeb> createState() => _WorkChatWidgetWebState();
}

class _WorkChatWidgetWebState extends State<WorkChatWidgetWeb> {
      ...
      child: Container(
        child: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: () async {
                  if (_appService.selectedChatUser['phone'] !=
                      null) if (!kIsWeb && (Platform.isAndroid || Platform.isIOS))
                        ...
                        children: [
                          ...
                          _appService.selectedJobData['reviews_info'] != null &&
                              ...
                              : Container(
                                  ...
                                  child: Text("Be the first to send offer",
                                      style: TextStyle(
                                          fontSize: 18,
                                          color: Color.fromRGBO(
                                              194, 194, 194, 1)))),
