...
class WorkChatWidget extends StatefulWidget {
  @override
  State<WorkChatWidget> createState() => _WorkChatWidgetState();
}

class _WorkChatWidgetState extends State<WorkChatWidget> {
