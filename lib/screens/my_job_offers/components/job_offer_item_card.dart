...
class JobOfferItemCard extends StatefulWidget {
  const JobOfferItemCard({required this.data});
  final data;

  @override
  _JobOfferItemCardState createState() => _JobOfferItemCardState();
}

class _JobOfferItemCardState extends State<JobOfferItemCard> {
  ...
  initData() async {
    ...
    dynamic response =
        await _appService.getUserProfile(userID: widget.data['user']['id']);
                ...
                Expanded(
                  ...
                  children: [
                    Text(
                      widget.data['title'] +
                          "   " +
                          (widget.data['user']['full_name'] == null
                              ? ""
                              : widget.data['user']['full_name']),
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    if (widget.data['user']['phone'] != null)
                      SizedBox(
                        height: 7,
                      ),
                    if (widget.data['user']['phone'] != null)
                  ...
                  onTap: () async {
                    if (widget.data['chat_room'] == null) {
                      ...
                      if (response is String || response == null) {
                        ...
                        dynamic responseProfile = await _appService
                            .getUserProfile(userID: widget.data['user_id']);
                        if (responseProfile is String ||
